...
public class GetOneUpdatedMongo extends AbstractSessionFactoryProcessor {
  ...
  public final void onTrigger(final ProcessContext context, final ProcessSessionFactory sessionFactory) {
    //-2000 大概为半小时之前的位点
    BsonTimestamp bts = new BsonTimestamp((int) (new Date().getTime() / 1000) - 2000, 0);
    ...
    try {
      ...
      try {
        ...
        Document currentDoc = (Document)jsonArray.get(0);
        ...
        if(dbName.equals(namespace[0])) {
          ...
          flowFile = session.write(flowFile, new OutputStreamCallback() {
            ...
            public void process(OutputStream outputStream) throws IOException {
              IOUtils.write(oDoc.toJson(), outputStream);
            }
          });
